        ...
        <!-- activity -->
          ...
          <div>
            <b-dropdown id="dropdown-dropup" dropup text="Drop-Up" size="sm"  variant="link" toggle-class="text-decoration-none pr-0" no-caret>
              ...
              <b-dropdown-item size="sm" @click="goToProfile">Profile</b-dropdown-item>
