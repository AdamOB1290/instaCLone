<template>
    <div class="follow_suggestions_wrapper">
        <div class="welcome follow_suggestions text-center mb-0 ">
            ...
            <p class="welcome_message mx-4 my-0">
        ...
        <slick
            ...
            v-for="(page, key) in slickForLoop"
            :key="key"
            class="pt-6 pb-10 lg:pb-0 follow_suggestions d-flex justify-content-center align-items-center"
        >
            <div
                v-for="(user, key) in userFeed"
                :key="key"
                class="user_wrapper pt-4 pb-2 px-1 position-relative"
            >
                <observer
                    class="position-absolute"
                    :id="'slickOsberver' + user.id"
                    :data-slickIndex="key"
                    v-on:intersect="reInit"
                />
                <div class="card py-2 px-1 border-0 mx-1">
                    <div
                        class="card-head d-flex flex-column align-items-center justify-content-center"
                    >
                        <img
                            @click="goToProfile"
                            :data-userId="user.id"
                            class="suggestion_pfp rounded-circle"
                            :src="user.pfp"
                        />
                        <span
                            @click="goToProfile"
                            :data-userId="user.id"
                            class="suggestion_username font-weight-bold"
                            >{{ user.username }}</span
                        >
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div
                            class="d-flex justify-content-center align-items-center image_wrapper"
                        >
                            <div
                                v-for="(post, key) in user.top_posts.slice(
                                    0,
                                    3
                                )"
                                :key="key"
                            ...
                            >
                                <img
                                    ...
                                    class="cursor-pointer suggestion_images rounded-0"
                                    :src="post.media_file"
                                />
                            </div>
                        </div>
